...
type
  TDM = class(TDataModule)
    ...
    FDQAlunoXaula: TFDQuery;
    FDQAlunoXaulaaluno_id: TFDAutoIncField;
    FDQAlunoXaulaaluno_cpf: TStringField;
    FDQAlunoXaulaaluno_nome: TStringField;
    FDQAlunoXaulaaluno_celular: TStringField;
    FDQAlunoXaulaaluno_email: TStringField;
    FDQAlunoXaulaaluno_observacao: TStringField;
    FDQAlunoXaulaaluno_img: TBlobField;
